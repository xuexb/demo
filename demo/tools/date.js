...
(function(date, window) {
     ...
     *
     * @example
     *     1, date.elapsed('1397535629151') => 1小时前
     *     2, date.elapsed('1397017408705') => 2014-4-9 12:23
     *     3, date.elapsed('1397449844036') => 昨天12:30
     *     4, date.elapsed('1397447010786') => 昨天11:43
     *     5, date.elapsed('1394297361000', true) => 2014-3-9
     */
    date.elapsed = function(e, mark) {
        ...
        if (past < 10) {
            ...
            result = mark ? date.format('yyyy-MM-dd', e) : date.format('yyyy-MM-dd HH:mm', e);
        }
        return result;
    }
     ...
     * 传日期格式化
     */
    date.elapsed_date = function(str, mark){
        if (!(str instanceof Date)) {
            str = new Date(str);
        }

        return date.elapsed(str.getTime(), mark)
    }
